...
|---|---|---|---|---|---|---|---|---|
| E1 | `TK-6` | Identity & RBAC | `module:auth` | 10 | 37 | Sprint 1-3 (MF-01 foundation: auth) | Lâm Phi Long | Đỗ Đăng Khoa |
| E2 | `TK-7` | Device Fleet & Maintenance | `module:devices` | 12 | 42 | Sprint 1-3 (MF-01 / MF-05: device fleet) | Nguyễn Ngọc Long | Đỗ Đăng Khoa |
| E3 | `TK-8` | Trip & Rental Management | `module:trips`, `module:rentals` | 18 | 65 | Sprint 1-3 (MF-01: trips & rentals) | Lâm Phi Long | Đỗ Đăng Khoa |
| E4 | `TK-9` | Gateway & Offline Sync | `module:gateway-sync` | 14 | 87 | Sprint 1-3 (MF-02: gateway & offline sync) | Đỗ Đăng Khoa | Đỗ Đăng Khoa |
| E5 | `TK-10` | Real-Time Monitoring & SOS Incidents | `module:monitoring`, `module:incidents` | 15 | 65 | Sprint 2-4 (MF-03 + MF-04) | Nguyễn Bá Tân | Đỗ Đăng Khoa |
| E6 | `TK-11` | Billing & Reporting | `module:billing` | 8 | 25 | Sprint 2-5 (MF-05: billing) | Nguyễn Bá Tân | Đỗ Đăng Khoa |
| E7 | `TK-12` | DevOps / CI-CD | `module:devops` | 7 | 21 | Sprint 1 then ongoing (cross-cutting, not a Main Flow) | Đỗ Đăng Khoa | Đỗ Đăng Khoa |
| E8 | `TK-13` | Research & Experimental Evaluation | `module:docs` | 6 | 49 | Sprint 6 (cross-cutting research, not a Main Flow) | Đỗ Đăng Khoa | Đỗ Đăng Khoa |
