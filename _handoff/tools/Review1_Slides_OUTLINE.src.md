...
| 4 | Context Diagram | Level-0 DFD, one process, labelled flows | SRS Figure {fig:context} | **done** |
...
| 7 | Data Design, ERD | 5 to 8 core entities, PK, FK, cardinality | SRS Figures {fig:erd1} and {fig:erd2} (conceptual) | **done** conceptually; physical ERD from `schema.prisma` todo |
| 8 | Use Case Diagram | Actors, use cases, relationships | SRS Figures {fig:uc-mf01a} to {fig:uc-admin} | **done** |
| 9 | State Machine Diagram | The most complex entity: Incident | SRS Figure {fig:fsm-incident} (Device: Figure {fig:fsm-device}) | **done** |
| 10 | Activity Diagram | One Main Flow as activity or swimlane | SRS Figures {fig:mf01} to {fig:mf05} | **done** |
